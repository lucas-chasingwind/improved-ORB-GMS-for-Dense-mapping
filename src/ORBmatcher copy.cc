...
namespace ORB_SLAM3
{
                                       ...
                                       vector<MapPoint*> &vpMatched, int th, float ratioHamming)
    {
        ...
        std::chrono::steady_clock::time_point t2 = std::chrono::steady_clock::now();
        double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        std::cout << "ORB matches cost 3 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        total_3=total_3+mTimeORB_Mat;
        std::cout<<" total_3 = "<<total_3<<endl;
        return nmatches;
    }
                                       ...
                                       std::vector<MapPoint*> &vpMatched, std::vector<KeyFrame*> &vpMatchedKF, int th, float ratioHamming)
    {
        ...
        std::chrono::steady_clock::time_point t2 = std::chrono::steady_clock::now();
        double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        std::cout << "ORB matches cost 4 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        total_4=total_4+mTimeORB_Mat;
        std::cout<<" total_4 = "<<total_4<<endl;
        return nmatches;
    }
    ...
    int ORBmatcher::SearchForInitialization(Frame &F1, Frame &F2, vector<cv::Point2f> &vbPrevMatched, vector<int> &vnMatches12, int windowSize)
    {
        ...
        std::chrono::steady_clock::time_point t2 = std::chrono::steady_clock::now();
        double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        std::cout << "ORB matches cost 5 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        total_5=total_5+mTimeORB_Mat;
        std::cout<<" total_5 = "<<total_5<<endl;
        return nmatches;
    }
    ...
    int ORBmatcher::SearchByBoW(KeyFrame *pKF1, KeyFrame *pKF2, vector<MapPoint *> &vpMatches12)
    {
        ...
        std::chrono::steady_clock::time_point t2 = std::chrono::steady_clock::now();
        double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        std::cout << "ORB matches cost 6 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        total_6=total_6+mTimeORB_Mat;
        std::cout<<" total_6 = "<<total_6<<endl;
        return nmatches;
    }
                                           ...
                                           vector<pair<size_t, size_t> > &vMatchedPairs, const bool bOnlyStereo, const bool bCoarse)
    {
        ...
        std::chrono::steady_clock::time_point t2 = std::chrono::steady_clock::now();
        double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        std::cout << "ORB matches cost 7 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        total_7=total_7+mTimeORB_Mat;
        std::cout<<" total_7 = "<<total_7<<endl;
        return nmatches;
    }
    ...
    int ORBmatcher::SearchByProjection(Frame &CurrentFrame, KeyFrame *pKF, const set<MapPoint*> &sAlreadyFound, const float th , const int ORBdist)
    {
        ...
        std::chrono::steady_clock::time_point t2 = std::chrono::steady_clock::now();
        double mTimeORB_Mat = std::chrono::duration_cast<std::chrono::duration<double,std::milli> >(t2 - t1).count();
        std::cout << "ORB matches cost 9 = " << mTimeORB_Mat << " milliseconds. " << endl;  //add
        total_9=total_9+mTimeORB_Mat;
        std::cout<<" total_9 = "<<total_9<<endl;
        return nmatches;
    }
